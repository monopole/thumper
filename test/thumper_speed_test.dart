...
void main() {
  ...
  test('periods', () {
    expect(range[0].period, equals(Duration(milliseconds: 1000)));
    expect(range[1].period, equals(Duration(milliseconds: 800)));
    expect(range[2].period, equals(Duration(milliseconds: 400)));
    expect(range[3].period, equals(Duration(milliseconds: 100)));
    expect(range[4].period, equals(Duration(milliseconds: 30)));
  });
  ...
  test('mapUnitIntervalToSpeed', () {
    ...
    expect(range.mapUnitIntervalToSpeed(0.000).name, equals("slowest"));
    ...
    expect(range.mapUnitIntervalToSpeed(1.000).name, equals("fastest"));
